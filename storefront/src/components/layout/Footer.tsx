 ...
 * Footer Component
 * 
 * Premium footer with store info and links.
 */
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8">
          ...
          <div className="space-y-4">
            <Link href="/" className="flex items-center gap-3 group">
              <div className="relative w-12 h-12 rounded-full overflow-hidden ring-2 ring-primary-700 group-hover:ring-gold-500 transition-all duration-300">
                <Image
              ...
              <span className="font-semibold text-xl text-white group-hover:text-gold-400 transition-colors duration-300">
                {STORE_CONFIG.name}
              </span>
            </Link>
          ...
          <div>
            ...
            <div className="flex gap-4 mt-6">
              <a
                ...
                className="w-10 h-10 rounded-full bg-primary-800 hover:bg-gold-500 flex items-center justify-center transition-colors duration-300"
                aria-label="Facebook"
              >
        ...
        <div className="mt-12 pt-8 border-t border-primary-700">
          <p className="text-center text-primary-400 text-sm">
            © {currentYear} {STORE_CONFIG.name}. Todos los derechos reservados.
          </p>
        </div>
      </div>
    </footer>
