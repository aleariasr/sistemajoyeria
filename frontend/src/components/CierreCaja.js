          ...
          <div className="stats-grid">
            ...
            <div className="stat-card success">
              ...
              <div className="value" style={{ fontSize: '1.5rem' }}>
                {formatearMoneda(resumen?.total_efectivo_combinado || resumen?.total_efectivo || 0)}
              </div>
              <small>
                Ventas: {resumen?.ventas_efectivo || 0} | Abonos: {resumen?.abonos_efectivo || 0}
              </small>
            </div>
            ...
            <div className="stat-card info">
              ...
              <div className="value" style={{ fontSize: '1.5rem' }}>
                {formatearMoneda(resumen?.total_transferencia_combinado || resumen?.total_transferencia || 0)}
              </div>
              <small>
                Ventas: {resumen?.ventas_transferencia || 0} | Abonos: {resumen?.abonos_transferencia || 0}
              </small>
            </div>
            ...
            <div className="stat-card warning">
              <h4>Tarjeta</h4>
              <div className="value" style={{ fontSize: '1.5rem' }}>
                {formatearMoneda(resumen?.total_tarjeta_combinado || resumen?.total_tarjeta || 0)}
              </div>
              <small>
                Ventas: {resumen?.ventas_tarjeta || 0} | Abonos: {resumen?.abonos_tarjeta || 0}
              </small>
            </div>
